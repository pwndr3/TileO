public class PopUpAddConnection extends javax.swing.JFrame {

    /**
     * Creates new form PopUpActionCard
     */
    public PopUpAddConnection() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("Add Connection");
        ...
        jTextPane3.setText("Select a connection spot to add");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpAddConnection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpAddConnection().setVisible(true);
            }
        });
    }
